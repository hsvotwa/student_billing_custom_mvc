...
class TransactionMdl extends BaseMdl {
    ...
    public function __construct ( $id = null ) {
        ...
        $this->g_sql_table = "tbl_transaction";
    ...
    public function getFields () {
        ...
        $return["student_uuid"] = new FieldMdl( 
            "student_uuid", "student_uuid", "Student", true, EnumFieldDataType::_string, EnumFieldType::_string, $this->g_sql_table, true, "text telephone_number_field", $this->g_row, null, 2, null, LookupData::getAllStudents(), 6
        );
