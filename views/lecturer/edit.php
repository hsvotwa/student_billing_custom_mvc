                    ...
                    <div id="tab-gen">
                        ...
                        <table class="w-100">
                            <tr>
                                <td class="w-50">
                                    <?php
                                        echo $form_fields["full_name"]->getFieldHtmlLabel();
                                        echo $form_fields["full_name"]->getFieldHtml();
                                    ?>
                                </td>
                                <td class="w-50">
                                    <?php
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <a href="<?php echo APP_DOMAIN; ?>lecturers/manage" class="url">Go to list</a>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<?php
    echo $gen->getJavascriptRef('js/lecturer.js')
?>