                    ...
                    <div id="tab-gen">
                        ...
                        <table class="w-100">
                            <tr>
                                ...
                                <td class="w-50">
                                    <?php
                                        echo $form_fields["cost"]->getFieldHtmlLabel();
                                        echo $form_fields["cost"]->getFieldHtml();
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <a href="<?php echo APP_DOMAIN; ?>subjects/manage" class="url">Go to list</a>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<?php
    echo $gen->getJavascriptRef('js/subject.js')
?>